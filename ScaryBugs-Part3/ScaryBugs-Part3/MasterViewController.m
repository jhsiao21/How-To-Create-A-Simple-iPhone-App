...
#pragma mark Handle adding a new bug
-(void)addTapped:(id)sender{
    
    //Create a RWTScaryBugDoc with some default values, and add it to the bugs array.
    RWTScaryBugDoc *newBugDoc = [[RWTScaryBugDoc alloc]initWithTitle:@"New Bug" rating:0 thumbImage:nil fullImage:nil];
    [_bugs addObject:newBugDoc];
...
/*This method is called when the user chooses to modify a row in some way.*/
...
//ReloadData when the user is in the detail view, they might change the name of the bug or the picture, and you want the updated name/picture to show up when they come back to the table view.
